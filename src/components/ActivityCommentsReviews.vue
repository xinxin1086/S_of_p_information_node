                ...
                <div class="discussion-content">
                  ...
                  <div class="action-buttons">
                    <el-button
                      ...
                      v-if="!shouldHideMainDiscussionReplyBtn(discussion)"
                    >
                      回复讨论
                    </el-button>
                    <el-button
      ...
      <div v-if="activeTab === 'reviews'" class="tab-content">
        <div class="reviews-section">
          ...
          <div class="rating-content">
            ...
            <!-- 填写评分表单 -->
            <div class="rating-form" v-if="!hasRated">
...
import { useActivityStore } from '@/store/modules/activity.js'
...
// getUserInfo 函数已移除 - 直接使用讨论数据中的 author_display 和 author_avatar
